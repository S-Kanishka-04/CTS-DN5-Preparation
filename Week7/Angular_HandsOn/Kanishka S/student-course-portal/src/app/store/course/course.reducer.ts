...
/** Course feature state shape — HOL 9 Task 1. */
...
/**
 * Pure reducer — reducers must NEVER perform side effects (HTTP calls,
 * navigation). All async work happens in course.effects.ts instead.
 */
